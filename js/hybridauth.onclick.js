...
(function ($) {
  ...
  Backdrop.behaviors.hybridauth_onclick = {};
  Backdrop.behaviors.hybridauth_onclick.attach = function(context, settings) {
    ...
    $('.hybridauth-onclick-current:not(.hybridauth-onclick-processed)', context).addClass('hybridauth-onclick-processed').bind('click', function() {
      $(this).parents('.hybridauth-widget').after('<div>' + Backdrop.t('Contacting @title...', {'@title': this.title}) + '</div>');
    });
